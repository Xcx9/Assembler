...
void ab16(const void *p)
{
...

    {
        ...
        // Безопасно: сдвиг делаем над беззнаковой копией битов
...

    {
        ...
        // На данной платформе показываем поведение signed shift right
        int temp = (int)sx;
        int shifted = temp >> 1;
